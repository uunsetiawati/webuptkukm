          ...
          <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
              ...
              <div class="card-body p-4">
                <a href="<?=site_url('admin/pejabat/create')?>" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Tambah Pejabat</a>
                <hr>
                <h5 class="card-title fw-semibold mb-4">Pejabat</h5>
                        ...
                        <tr>
                            ...
                            <td>
                              <?php if (!empty($row['gambar'])): ?>
                                <img src="<?= base_url('uploads/pejabat/' . $row['gambar']) ?>" alt="Slider" width="100">
                              <?php else: ?>
                                  <span>Tidak ada gambar</span>
                              <?php endif; ?>
                            </td>                            
                            <td>
                            <a href="<?= base_url('admin/pejabat/edit/' . $row['id']) ?>" class="btn btn-success "><i class="fas fa-edit me-1"></i>Edit</a>
