    <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Tambah Pejabat</h5>
              <div class="card">
                <div class="card-body">
                  <form action="<?= base_url('admin/pejabat/store') ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      <label class="form-label" required>Jabatan</label>
                        ...
                        <?php foreach ($pejabat as $j): ?>
                            <option value="<?= $j ?>"><?= $j ?></option>
                        <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="mb-3">
                      <label class="form-label">Detail Jabatan</label>
